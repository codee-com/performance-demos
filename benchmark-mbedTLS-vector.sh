...
printf "  3. Vectorize the code with codee --rewrite\n"
...
printRunComm "codee --screening --config build/compile_commands.json --show-progress $CODEE_FLAGS"
tScreening1=$(date +%s%3N)

#===============================================================================
printf "\nStep 2 done.\n"
printf "##################################################\n"
printf "3/6. Vectorizing the code with codee --rewrite ...\n"
printf "##################################################\n"
if [ -z "$CONTINUOS_" ]; then
    read -p "Press enter to continue"
fi
